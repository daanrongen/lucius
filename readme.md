...
- [x] Onderzoek
	- [x] Onderzoeksvraag
	- [x] Deelvragen
	- [x] White papers met aantekeningen
	- [x] Interview Mariska van de Kaa
	- [x] Observatie Ben Groot
	- [x] Interview Ben Groot
- [x] Inzichten
	- [x] Job stories
	- [x] User Requirements
- [ ] Productontwikkeling
...
De structuur van dit document verloopt van abstracte naar concrete informatie over mijn afstudeerproject.

| Context | Inzichten | Oplossing |
|:--|:--|:--|
| Design Brief | Literatuuronderzoek | Ontwerp |
...
De Quality Function Deployment (QFD) is een methode om klantenwensen en marktvragen te vertalen in ontwerpeisen. Hierin worden User Requirements beschreven, productspecificaties en ontwikkelingsspecificaties. Deze eisen hebben betrekking op het gebruik en de werking van het product (NPD Solutions, 2016 [^NPD Solutions (2016). Customer-Focused Development with QFD: http://www.npd-solutions.com/qfd.html]). De QFD kan onderverdeeld worden in twee soorten eisen: functionele en niet-functionele eisen. De lijst van niet-functionele eisen kan onderverdeeld worden in *performance*- en *development*-eisen. Waarbij performance-eisen vaak ingaan op de bestendigheid, intelligentie en capabiliteit van het product, en de development-eisen inhoudelijk over ontwikkelingstijd, productiemiddelen en kwaliteit gaan (Coley Consulting, 2018 [^Coley Consulting (2018), User Requirements, https://www.coleyconsulting.co.uk/require.htm]). De QFD kan veel verschillende vormen aannemen, het kan schematisch worden weergegeven, in tabellen getekend worden, of tekstueel beschreven worden. In dit document kies ik er voor om het tekstueel te beschrijven.
...
De web-applicatie:
- Een web-applicatie die toont hoeveel de gebruiker statisch zit, dynamisch zit, staat en beweegt is. 
- De visualisatie van de data moest 'zit- en sta-ritmes' kunnen tonen.
- De gebruiker moest duidelijk kunnen zien wanneer hij/zij progressie behaald en beter zitgedrag vertoond.

Het fysieke product:
- Onder het zitoppervlakte van de Buoy een behuizing voor een gyroscoop en Arduino micro-computer en in het zitoppervlakte een druk-sensor.
- Een LED-strip om het zitoppervlakte van de Buoy die visualiseert hoelang er gezeten wordt en per tijdseenheid de in-chair movement weergeeft zodat collega's de gebruiker kunnen attenderen op slecht zitgedrag.
...
(+) In de grafiek wordt met kleur aangegeven welke waarden de gezonder zijn en de voorkeur krijgen. Zo is statisch zitten rood, dynamisch zitten oranje, staan geel en bewegen groen.

(-) De ringen van zitgedrag zijn onduidelijk. Het is onduidelijk of bij volle ringen de gebruiker goed of slecht gedrag vertoond en waar de uitdrukking van '70 pt' op slaat.
...
Het fysieke product: 
- Om het fysieke product te ontwerpen heb ik de hulp ingeschakeld van product-ontwerper Nick Rovroy. We zijn tot een ontwerp gekomen waarbij er een sensor-case vastgeschroefd kan worden onderaan het trapeziumdraad. In deze sensor-case zit de Arduino, gyroscoop en powerbank, maar ook een krachtige *COB LED* die een lichtsignaal projecteert in de koepel van het onderstel van de Buoy. Dit licht is altijd zichtbaar. Ook geeft de lamp de IoT-kruk nog meer karakteristieke eigenschappen van een boei in het water. De functie van een boei is om (bij nacht) schepen te waarschuwen voor een kustlijn. Het lichtsignaal van een boei is daarom ook een signaal van 'gevaar' en 'afstand'.
