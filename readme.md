...
## Introductie
In deze design brief beschrijf ik de urgentie van het probleem dat ik wil oplossen met mijn afstudeerproject aan de studie _Communication &amp; Multimedia Design_ aan de Hogeschool van Amsterdam in opdracht van HR-tech startup Healthy Workers. Het project valt te beschrijven als een intelligente welzijns-interventie dat verschillen in standaarden van comfort per kantoormedewerker benadrukt, met als doel om het collectief welzijn van kantoormedewerkers te verbeteren.
...
* [5. Bevindingen Veldonderzoek](#bevindingen-velonderzoek)
  ...
  * [5.4 Conclusie](#conclusie)
* [6. Ontwerpvraag](#ontwerpvraag)
  * [6.1 Recap](#recap)
  * [6.2 Design Challenges](#design-challenges)
* [7. Planning](#planning)
...
<details>
<summary><b>Fysieke omgevings-stressoren in relatie tot werkprestaties</b></summary>
  <p>
  <h4>Fysieke omgevings-stressoren in relatie tot werkprestaties</h4>
...
Op basis van de bevindingen uit zowel het literatuuronderzoek als het veldonderzoek heb ik een  ontwerpvraag geformuleerd:
...
### Recap
Stress bij kantoormedewerkers is beroepsziekte nummer één. Stress wordt veroorzaakt door stressoren en hebben een grote invloed op het gevoel van engagement, productiviteit, concentratie en alomvattend welzijn. Stressoren in de fysieke werkomgeving zijn voornamelijk afkomstig van klimaat-, licht-, geluids- en ergonomische factoren. Kantoormedewerkers zijn zich bewust van wanneer stressoren actief zijn. Ze kunnen de stressor en haar gewicht definiëren. Het probleem is echter dat ze moeite hebben met uitdrukken wat de ideale waarde van de specifieke omgevingsfactor is.

_Voorbeeld:_
> Kantoormedewerker: "Ik stoor me aan de huidige temperatuur (stressor), ik vind het veel te warm (gewicht), ik denk dat 18 °C fijner zou zijn (vage inschatting van comfort-standaard)"

Kantoormedewerkers reageren verschillend op een actieve stressor. Zo geeft bijna eenderde van de ondervraagde kantoormedewerkers aan dat ze verwachten dat het management stressoren verhelpt. Een andere groep geeft aan zich te verplaatsen als de werkomgeving oncomfortabel is. De grootste groep zegt dat ze idealiter gezamenlijk verantwoordelijk zijn voor een fijne werkomgeving. Door middel van communicatie willen ze stressoren verhelpen om het comfort voor de rest te optimaliseren.

### Design Challenges

Om het theoretische kader van het onderzoek en de bevindingen uit het veldonderzoek te concretiseren naar een praktische toepassing, heb ik de volgende design challenges geformuleerd:
...
- [ ] Hoe kun je middels een ergonomische interventie MSD's en CVD's afzwakken en zitgedrag inzichtelijk maken?
