...
> Hoe kun je stressoren in de fysieke werkomgeving inzichtelijk maken voor kantoormedewerkers die full-time bij een corporate bedrijf werken, door middel van een web-app die verbonden is met een IoT-device, om het comfort van de werkplek te optimaliseren zodat stress afzwakt, waarbij de focus ligt op een ergonomische interventie.
